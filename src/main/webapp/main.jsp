...
<body>
    ...
    <div class="bodywrap">
        <div class="img-slide">
            <div class="slide-list">
                <ul>
                    <li>
                        <a href="#">
                            <img class="banner-img" src="resources/img/청계천.jpg" alt="이미지1">     
                        </a>
                        <span>강화 양오낚시터 빙어축제
                        	<p>2023.12.23 ~ 2024.02.18</p>
                        	<p>인천 강화군</p>
                        </span>
                    </li>
                    <li>
                        <a href="#">
                            <img class="banner-img" src="resources/img/송현동.jpg" alt="이미지2">     
                        </a>
                        <span>송현동 솔빛축제
                        	<p>2023.12.15 ~ 2024.01.21</p>
                        	<p>서울 종로구</p>
                        </span>
                    </li>
                    <li>
                        <a href="#"> 
                            <img class="banner-img" src="resources/img/서울라이트.png" alt="이미지3">     
                        </a>     
                        <span>서울라이트 DDP
                        	<p>2023.12.21 ~ 2023.12.31</p>
                        	<p>서울 중구</p>
                        </span>
                    </li>
                </ul>
        ...
        <div class="soon-fstv">
        	<h2>곧 시작되는 축제 <i class="fa-solid fa-calendar-days" style="color: #fbd037;"></i></h2>
        	<div class="multi-slide">
	            <div class="multi-slide-list">
	                <ul>
	                    <li>
	                        <a href="fstv_detail.jsp">
	                            <img src="resources/img/test.jpg" alt="이미지1">
	                            <div class="fstv-title">겨울, 청계천의 빛</div>
	                            <div class="fstv-loc">서울 중구</div>
	                            <div class="fstv-date">2023.12.15 ~ 2023.12.31</div>
	                            <p class="fstv-comment">올해로 9회째를 맞는 '2023 겨울, 청계천의 빛'이 12월 15일부터 31일까지 청계과장광장에서 모전교 구간에서 열린다. 푸른 별 지구의 모습을 블루 앤 화이트로 연출한 대형 트리, 사랑스러운 하얀 북극곰과 빙산 트러스 장식, 광장을 장식한 동그란 얼음 조각과 얼음 터널 등 지구온난화로 전 세계가 어려움을 겪는 가운데 아름답고 행복한 지구를 만들자는 소망을 빛으로 담았다.</p>
	                        </a>
	                    </li>  
	                    <li>
	                        <a href="#">
	                            <img src="resources/img/test2.jpg" alt="이미지2">
	                            <div class="fstv-title">광화문광장 마켓</div>
	                            <div class="fstv-loc">서울 종로구</div>
	                            <div class="fstv-date">2023.12.15 ~ 2024.01.21</div>
	                            <p class="fstv-comment">2022년, 130만명이 참여한 '서울빛초롱축제'와 함께 진행되는 '2023-2024 광화문광장 마켓은 2022년 12월, 서울 도심 야간관광 활성화를 위해 신규 개최된 겨울철 대표 소상공인 플리마켓으로, 지역 소상공인과 함께 시즌 소품, 수공예품, 겨울철 먹거리 등을 전시·판매한다. 이번 광화문광장 마켓은 작년의 2배 규모로 확대하여 개최될 예정이며, 푸드트럭 등의 먹거리 부스존을 마련하여 보다 다양한 분야의 마켓부스가 구성된다.</p>
	                        </a>
	                    </li>
	                    <li>
	                        <a href="#">   
	                    ...
	                    <li>
	                        <a href="#">
	                            ...
	                            <div class="fstv-loc">서울 종로구</div>
	                            <div class="fstv-date">2023.12.15 ~ 2024.01.21</div>
	                            <p class="fstv-comment">서울빛초롱축제는 2009년부터 시작하여 15회차를 맞이하는 서울 대표 야간 빛 축제로, 빛 조형물 전시와 다양한 체험 프로그램 등 화려한 볼거리를 제공한다. 특히, 이번 2023 서울빛초롱축제는 광화문광장~청계광장~서울광장까지 확대하여 개최되며, 작년부터 시범운영으로 시작한 광화문광장 마켓과 동시 개최하여 볼거리뿐만 아니라 즐길거리, 먹거리까지 선보인다.</p>  
	                        </a>
	                    </li>  
	                    <li>
	                        <a href="#">
	                            <img src="resources/img/송현동.png" alt="이미지2">
	                            <div class="fstv-title">송현동 솔빛축제</div>
	                            <div class="fstv-loc">서울 종로구</div>
	                            <div class="fstv-date">2023.12.15 ~ 2024.01.21</div>
	                            <p class="fstv-comment">서울 도심 한복판, 자연 그대로의 모습을 간직한 송현동 녹지광장이 다채로운 조명과 빛을 품은 새로운 공간으로 변신, 올겨울 시민과 관광객에게 선보인다. ‘2023 송현동 솔빛축제’는 ‘신비로운 빛의 정원을 거닐며 초자연을 만나다’를 주제로, ▴빛의 언덕, ▴빛의 산책, ▴그림자 숲, ▴빛의 소리, ▴중앙가든, ▴빛의 길 등 여섯 가지 전시공간으로 구성된다. 각 공간은 과거 송현동의 울창했던 소나무 숲의 모습에 다채로운 빛의 향연을 투영, 독창적으로 표현한다. 현장에는 빛 조형물 전시뿐만 아니라 다양한 시민 참여 이벤트, 호빵‧붕어빵 등 간단한 K-간식을 맛볼 수 있는 부스, 기념품 판매점 등을 운영한다.</p>  
	                        </a>
	                    </li>
	                    <li>
	                        <a href="#">   
