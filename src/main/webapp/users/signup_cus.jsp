...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/signup_cus.js"></script>
</head>
<body>
	...
	<div class="bodywrap" style="margin: 120px 0px 180px;">
		<div class="signup-form">
			...
			<hr>
			<form action="create_account_consumer" class="input-form"
				method="post">
				<div>
					<i class="fa-regular fa-user"></i> <input type="email" id="user_id"
				...
				<div id="password_box">
					<i class="fa-solid fa-unlock-keyhole"></i> <input type="password"
						...
						required>
					<output id="passwordMessage"
						style="color: red; font-size: 10px; margin-top: 4px;"></output>
				</div>
				<div id="password_box2">
					<i class="fa-solid fa-unlock-keyhole"></i> <input type="password"
						id="user_password2" name="user_password2" placeholder="비밀번호 확인"
						required>
					<output id="passwordMessage2"
						style="color: red; font-size: 10px; margin-top: 4px;"></output>
				</div>
				<div>
					<i class="fa-regular fa-user"></i> <input type="text"
						id="user_name" name="user_name" placeholder="이름" required>
				</div>
				<div>
					<i class="fa-solid fa-mobile-screen"></i> <input type="text"
						id="user_tel" name="user_tel" value="<%=phone_number%>"
