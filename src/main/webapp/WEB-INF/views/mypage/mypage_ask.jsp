...
<link rel="stylesheet" href="resources/css/mypage_ask_detail.css"
	type="text/css">
<script type="text/javascript" src="resources/js/mypage_ask.js" defer> </script>
<%
List<AskVO> VO = (List<AskVO>) request.getAttribute("list");
%>
<div id="whole"> <!-- 문의내역 리스트 -->
<h1>내 문의내역</h1>
<br>
<hr class="shadow">
<br>
<div class="ask-list">
	...
	<div class="ask-form">
		<div class="ask-detail">
			...
			<div class="ask-info"><%=list.getUser_id()%> | <%=list.getAsk_created_at()%></div>
			<br>
			<p class="ask-content">
				<%=list.getAsk_content()%>
			</p>
